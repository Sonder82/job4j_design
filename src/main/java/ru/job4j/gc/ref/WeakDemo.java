...
public class WeakDemo {
    ...
    /**
     * В методе за'null'ение сильной ссылки приводит к удалению объекта
    ...
    /**
     * В методе мы создаем объект вообще без сильной ссылки.
    ...
    /**
     * Метод демонстрирует "жизнь" объекта со слабой ссылкой.
     * Его взаимосвязь с очередью ReferenceQueue.
      * @throws InterruptedException
     */
