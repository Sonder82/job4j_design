...
/**
 * Menu.
 * Структура меню древовидная.
 * Структурный элемент это MenuItem, т.е. на основе MenuItem строится дерево меню.
 ...
 * Menu наследуется от Iterable.
 * Это значит, что меню можно легко обойти через обычный цикл.
