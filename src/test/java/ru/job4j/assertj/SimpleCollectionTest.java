...
class SimpleCollectionTest {
    ...
    /**
     * Этот тестовый метод показывает основные операции
    ...
    /**
     * Этот тестовый метод показывает, как можно проверить выполнение
    ...
    /**
     * Этот тестовый метод показывает, что можно выбрать один элемент
    ...
    /**
     * Этот тестовый метод показывает, как можно выбрать из коллекции группу элементов
